...
const inlay_hints_1 = __webpack_require__(54);
    ...
    if (vscode_languageserver_protocol_1.TextDocumentEdit.is(change)) {
        for (const indel of change.edits) {
            ...
            if (parsed) {
                ...
                selection = vscode_languageserver_protocol_1.Range.create(startLine, startColumn, startLine, endColumn);
                const newChange = vscode_languageserver_protocol_1.TextDocumentEdit.create(change.textDocument, [vscode_languageserver_protocol_1.TextEdit.replace(indel.range, newText)]);
...
const downloader_1 = __webpack_require__(43);
const status_display_1 = __webpack_require__(51);
...
class Ctx {
    ...
    async activateStatusDisplay() {
        await this.client.onReady();
        const status = new status_display_1.StatusDisplay(this.config.checkOnSave.command);
        this.extCtx.subscriptions.push(status);
        this.client.onProgress(vscode_languageserver_protocol_1.WorkDoneProgress.type, 'rustAnalyzer/cargoWatcher', (params) => status.handleProgressNotification(params));
    }
    ...
    async checkUpdate(auto = true) {
        ...
        if (ret === 0) {
            ...
            try {
                ...
                coc_nvim_1.workspace.showMessage(`Upgrade rust-analyzer failed, please try again`, 'error');
                return;
            }
            this.client.start();
            this.activateStatusDisplay();
            ...
            coc_nvim_1.commands.executeCommand('vscode.open', 'https://github.com/rust-analyzer/rust-analyzer/releases').catch(() => { });
        }
    }
...
function isSnippetEdit(action) {
    var _a, _b;
    const documentChanges = (_b = (_a = action.edit) === null || _a === void 0 ? void 0 : _a.documentChanges) !== null && _b !== void 0 ? _b : [];
    for (const edit of documentChanges) {
        if (vscode_languageserver_protocol_1.TextDocumentEdit.is(edit)) {
            if (edit.edits.some((indel) => indel.insertTextFormat === vscode_languageserver_protocol_1.InsertTextFormat.Snippet)) {
                return true;
            }
        }
    }
        ...
        middleware: {
            ...
            async provideCodeActions(document, range, context, token) {
                ...
                for (const item of values) {
                    if (vscode_languageserver_protocol_1.CodeAction.is(item) && isSnippetEdit(item)) {
                        item.command = vscode_languageserver_protocol_1.Command.create('', 'rust-analyzer.applySnippetWorkspaceEdit', item.edit);
                        item.edit = undefined;
                    }
                    result.push(item);
                }
...
const coc_nvim_1 = __webpack_require__(1);
const fs_1 = __webpack_require__(2);
const node_fetch_1 = __importDefault(__webpack_require__(44));
const os_1 = __importDefault(__webpack_require__(16));
const path_1 = __webpack_require__(15);
const stream_1 = __importDefault(__webpack_require__(45));
const util_1 = __importDefault(__webpack_require__(50));
...
async function getLatestRelease(updatesChannel) {
    ...
    return node_fetch_1.default(releaseURL)
        .then((resp) => resp.json())
        .then((resp) => {
...
async function downloadServer(context, updatesChannel) {
    ...
    const _path = path_1.join(context.storagePath, latest.name);
    statusItem.text = `Downloading rust-analyzer ${latest.tag}`;
    const resp = await node_fetch_1.default(latest.url);
    ...
    const destFileStream = fs_1.createWriteStream(_path, { mode: 0o755 });
...
/* harmony import */ var http__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(46);
/* harmony import */ var url__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(47);
/* harmony import */ var https__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(48);
/* harmony import */ var zlib__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(49);
...
Object.defineProperty(exports, "__esModule", { value: true });
exports.ssr = exports.inlayHints = exports.runnables = exports.onEnter = exports.joinLines = exports.parentModule = exports.matchingBrace = exports.expandMacro = exports.syntaxTree = exports.collectGarbage = exports.analyzerStatus = void 0;
...
exports.runnables = new lc.RequestType('rust-analyzer/runnables');
...
let Config = /** @class */ (() => {
    class Config {
        ...
        async onConfigChange(event) {
            ...
            coc_nvim_1.workspace.showPrompt(`${msg}. Reload Now?`).then((prompt) => {
                if (prompt) {
        ...
        get checkOnSave() {
            return {
                command: this.cfg.get('checkOnSave.command'),
            };
        }
        get channel() {
        ...
        get lens() {
            return {
                enable: this.cfg.get('lens.enable'),
                run: this.cfg.get('lens.run'),
                debug: false,
                implementations: this.cfg.get('lens.implementations'),
            };
        }
    }
